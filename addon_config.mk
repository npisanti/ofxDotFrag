...
meta:
	ADDON_NAME = ofxDotFrag
	ADDON_DESCRIPTION = cross compatible GL/GLES shaders to be tweaked in realtime
	ADDON_AUTHOR = @npisanti
	ADDON_TAGS = "graphics" "shader"
	ADDON_URL = http://github.com/npisanti/ofxDotFrag
